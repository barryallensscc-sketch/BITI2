...
function seedDefaults(){
  ...
  if(isNew){
    ...
    s(K.settings,{phone:'+88 01701 292270',email:'info@bditinstitute.com',address:'Anowar Mansion (4th Floor), 15 Senpara Parbota, Mirpur-10, Dhaka-1216',admissionText:'Admissions are open for September 2026',siteName:'Bangladesh IT Institute'});
    s(K.submissions,[]);
  }
...
function saveSettings(){
  ...
  s(K.settings,st);toast('Settings saved','success');
}
